...
using Argo_Books.ReportGenerator;
...
namespace Argo_Books
{
    ...
    public partial class MainMenu_Form : BaseForm
    {
        ...
        private void MainMenu_form_Shown(object sender, EventArgs e)
        {
            ...
            Log.Write(2, "Argo Books has finished starting");
        ...
        {
            Log.Write(2, "Closing Argo Books");
        ...
        {
            Text = $"Argo Books {Tools.GetVersionNumber()} - {Directories.CompanyName}";
        }
